...
func update_status():
	...
	STATE.STATUS_BAR_CANVAS.get_node("StatusBar/PARTS_TEXT").text  = DATA_TO_UI.insert_leading_zeros( number_of_available_or_equipt_parts)
	STATE.STATUS_BAR_CANVAS.get_node("StatusBar/MECH_TEXT").text = DATA_TO_UI.insert_leading_zeros(number_of_available_or_active_mechs)
